...
#tolong revisi om wkwk gtw dah aku ngasal try and except 
plot = True
try:
    while plot: 
        mode = input('\nPilihan anda (A/B/C): ')
        ...
        if mode == 'A':
            ...
            print('Pilihan tidak tersedia') #pgn ku gak pakek else langsung except, tapi kalok gak pakek else ntar waktu user input selain A, B, C dia gak masuk ke except
                                            

        if mode == 'stop':
            plot = False
except:
    print('Terimakasih sudah menggunakan program ini')  #tapi kalo exceptnya dihilangkan ntar waktu pilih mode plot ini gak ditampilkan 

#tadi juga mau tak kasih finally tapi ya bingung mau print apa
#sry ribet ya om instruksine wkwk
